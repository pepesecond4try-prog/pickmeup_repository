  ...
  useEffect(() => {
    ...
    const checkStandalone = () => {
      const isStandaloneMode = 
        ...
        (import.meta.env.VITE_ALLOW_BROWSER_BYPASS === 'true' && window.location.search.includes('force_standalone=true'));
      
      // For development purposes, we might want to bypass this check
      // but the prompt strictly requires blocking if not standalone.
      // We will enforce it strictly, but allow a query param for testing on Netlify if explicitly enabled.
